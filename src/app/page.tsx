  ...
  return (
    <main className="relative overflow-hidden">
      ...
      <section className="relative min-h-[92vh] flex items-center justify-center pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[340px] sm:w-[500px] md:w-[600px] h-[340px] sm:h-[500px] md:h-[600px] rounded-full bg-gradient-to-tr from-[#e2682f]/20 via-[#f2a96f]/10 to-transparent blur-[90px] sm:blur-[130px] pointer-events-none animate-orb-glow -z-10" />

        <div className="max-w-5xl mx-auto text-center space-y-8 relative z-10">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold bg-[#e2682f]/15 text-[#f2a96f] border border-[#e2682f]/30 backdrop-blur-md shadow-lg shadow-[#e2682f]/5">
            <Sparkles className="w-3.5 h-3.5 text-[#e2682f]" />
            <span>AI Companion for Daily Audio Manifestation</span>
          </div>

          {/* Headline */}
          <h1 className="font-serif-luxury text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight text-[#f5f2e8] leading-[1.08]">
            Your dream life, <br />
            <span className="italic font-normal text-transparent bg-clip-text bg-gradient-to-r from-[#f2a96f] via-[#e2682f] to-[#dad5be]">
              spoken into reality
            </span>{' '}
            every morning.
          </h1>
          ...
          {/* Subtitle */}
          <p className="max-w-2xl mx-auto text-base sm:text-lg md:text-xl text-[#dad5be] leading-relaxed font-light">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <a
              href="#experience"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full text-sm font-semibold uppercase tracking-wider text-[#dad5be] glass-panel hover:text-[#f5f2e8] hover:border-white/20 transition-colors"
            >
          ...
          {/* Trust points */}
          <div className="pt-8 flex flex-wrap items-center justify-center gap-6 text-xs text-[#8a8265]">
            ...
            <span>•</span>
            <span className="flex items-center gap-1.5">
              <Sparkles className="w-4 h-4 text-[#f2a96f]" />
      ...
      <section id="experience" className="py-24 px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center space-y-4 mb-12">
          ...
          <h2 className="font-serif-luxury text-4xl sm:text-5xl font-bold text-[#f5f2e8]">
            Hear What Morning Clarity Sounds Like
          </h2>
          <p className="text-base sm:text-lg text-[#8a8265] max-w-xl mx-auto">
      ...
      <section id="features" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <p className="text-base sm:text-lg text-[#8a8265]">
            Built from psychology, neuroscience, and ethical AI — without the spammy notification tactics or guilt.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Card 1 */}
          <div className="glass-panel rounded-3xl p-8 sm:p-10 border border-white/5 hover:border-[#e2682f]/30 transition-all group space-y-4">
            ...
            <p className="text-sm sm:text-base text-[#dad5be] leading-relaxed">
      ...
      {/* ============================================================ */}
      <section id="showcase" className="py-24 px-4 sm:px-6 lg:px-8 relative bg-black/30 border-y border-white/5">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div className="glass-panel rounded-3xl overflow-hidden border border-white/10">
          <div className="grid grid-cols-12 bg-white/5 p-4 sm:p-6 text-xs uppercase tracking-wider font-semibold text-[#8a8265] border-b border-white/10">
          ...
          <div className="divide-y divide-white/5 text-sm sm:text-base text-[#dad5be]">
            <div className="grid grid-cols-12 p-4 sm:p-6 items-center">
              <div className="col-span-5 sm:col-span-6 font-medium text-[#f5f2e8]">
                Audio Personalization
              </div>
              <div className="col-span-4 sm:col-span-3 text-center text-[#f2a96f] font-medium">
                Unique daily AI generation
              </div>
              <div className="col-span-3 sm:col-span-3 text-center text-[#8a8265]">
                Static recorded tracks
              </div>
            </div>

            <div className="grid grid-cols-12 p-4 sm:p-6 items-center bg-white/[0.02]">
              <div className="col-span-5 sm:col-span-6 font-medium text-[#f5f2e8]">
                Memory & Continuity
              </div>
              <div className="col-span-4 sm:col-span-3 text-center text-[#f2a96f] font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="glass-panel-glow rounded-3xl p-8 sm:p-10 border-2 border-[#e2682f] relative space-y-6 flex flex-col justify-between">
            ...
            <div className="space-y-4">
              <h3 className="font-serif-luxury text-3xl font-bold text-[#f5f2e8]">
                Annual Membership
              </h3>
              <p className="text-sm text-[#8a8265]">
                The complete daily ritual. Wake up to personalized audio moments every morning.
              </p>
              <div className="pt-2 flex items-baseline gap-2">
                <span className="text-4xl font-bold font-serif-luxury text-[#f5f2e8]">$49.99</span>
                <span className="text-xs text-[#8a8265]">/ year ($4.16/mo)</span>
              </div>
              <ul className="space-y-3 text-sm text-[#dad5be] pt-4">
          ...
          {/* Monthly Tier */}
          <div className="glass-panel rounded-3xl p-8 sm:p-10 border border-white/10 space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
              <h3 className="font-serif-luxury text-3xl font-bold text-[#f5f2e8]">
                Monthly Membership
              </h3>
              ...
              <div className="pt-2 flex items-baseline gap-2">
                <span className="text-4xl font-bold font-serif-luxury text-[#f5f2e8]">$7.99</span>
                <span className="text-xs text-[#8a8265]">/ month</span>
              </div>
              <ul className="space-y-3 text-sm text-[#dad5be] pt-4">
                <li className="flex items-center gap-2.5">
                  <Check className="w-4 h-4 text-[#8a8265]" />
            ...
            <a
              href="#download"
              className="w-full text-center py-4 rounded-full text-xs font-semibold uppercase tracking-wider text-[#dad5be] glass-panel hover:text-white hover:border-white/20 block mt-6"
            >
              Subscribe Monthly
            </a>
          </div>
